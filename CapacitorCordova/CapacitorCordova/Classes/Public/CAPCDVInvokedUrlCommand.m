...
#import "CAPCDVInvokedUrlCommand.h"


@implementation CAPCDVInvokedUrlCommand
...
+ (CAPCDVInvokedUrlCommand*)commandFromJson:(NSArray*)jsonEntry
{
    return [[CAPCDVInvokedUrlCommand alloc] initFromJson:jsonEntry];
}
